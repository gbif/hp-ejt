...
[![Build Status](https://builds.gbif.org/job/hp-ejt/badge/icon)](https://builds.gbif.org/job/hp-ejt/lastBuild/console)
...
# GBIF Hosted Portal: ejt

This Jekyll website, **[ejt (Staging)](https://ejt.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
